...
export async function POST(req: NextRequest) {
  try {
    ...
    // Fetch all company memberships with per-company role
    ...
    // Role: admin/consultant keep their global role
    // client/client-MR get role from first company membership
