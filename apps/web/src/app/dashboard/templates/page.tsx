  ...
  async function handleCreate() {
    ...
    try {
      const res = await fetch('/api/templates', {
        ...
        body: JSON.stringify({ name: createName, tag_code: createTag }),
      })
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 22 }}>
        ...
        <button
          ...
          style={{
            ...
            background: '#185FA5', border: '0.5px solid #185FA5', borderRadius: 8,
              ...
              <div key={t.id} style={{
                ...
                <div style={{ padding: '12px 16px', display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: '#9b9991', fontFamily: 'monospace' }}>${t.tag_code}</div>
                  </div>
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <input
                ...
                placeholder="e.g. Risk Management File"
                autoFocus
              />
            </div>
