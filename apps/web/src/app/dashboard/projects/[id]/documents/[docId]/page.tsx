      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', height: 48, flexShrink: 0, borderBottom: '1px solid #e0ddd8', background: '#fff', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          {(isAdmin || isConsultant || isClientMR) && isReview && (
            <>
              {doc?.annex === 'STED' ? (
                <button onClick={() => setShowStedApprove(true)} style={{ height: 28, padding: '0 12px', fontSize: 12, cursor: 'pointer', background: '#856404', border: 'none', borderRadius: 6, color: '#fff', fontWeight: 500 }}>✓ Approve TF</button>
              ) : (
            ...
            <div style={{ background: '#FFF3CD', border: '0.5px solid #FFEEBA', borderRadius: 8, padding: '10px 14px', marginBottom: 18 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <div style={{ textAlign: 'center' as const }}>
                  <div style={{ fontSize: 10, color: '#856404', marginBottom: 2 }}>X</div>
                ...
                <span style={{ fontSize: 20, color: '#856404' }}>.</span>
                <div style={{ textAlign: 'center' as const }}>
                  <div style={{ fontSize: 10, color: '#856404', marginBottom: 2 }}>Y</div>
                  <input type="number" min={0} value={stedVersionY} onChange={e => setSedVersionY(Math.max(0, parseInt(e.target.value) || 0))}
                    style={{ width: 56, height: 34, textAlign: 'center' as const, fontSize: 16, fontWeight: 700, border: '1.5px solid #FFEEBA', borderRadius: 6, outline: 'none', color: '#856404' }} />
                </div>
                <span style={{ fontSize: 20, color: '#856404' }}>.</span>
                <div style={{ textAlign: 'center' as const }}>
                  <div style={{ fontSize: 10, color: '#856404', marginBottom: 2 }}>Z</div>
