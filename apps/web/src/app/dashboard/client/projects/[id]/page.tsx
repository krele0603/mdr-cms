          ...
          {activeAnnex === 'Annex III' && (
            <div style={{ padding: '11px 14px', borderTop: '0.5px solid rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: 10, background: 'rgba(24,95,165,0.03)' }}>
              ...
              <Link href={`/dashboard/projects/${id}/requirements`}
                style={{ height: 26, padding: '0 14px', fontSize: 11, background: '#E6F1FB', border: '0.5px solid #85B7EB', borderRadius: 6, color: '#185FA5', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', fontWeight: 500 }}>
                Open Requirements
              </Link>
            </div>
          )}
          ...
          {activeAnnex === 'Annex VI' && (
            <div style={{ padding: '11px 14px', borderTop: '0.5px solid rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: 10, background: 'rgba(60,52,137,0.03)' }}>
              ...
              <Link href={`/dashboard/projects/${id}/traceability`}
                style={{ height: 26, padding: '0 14px', fontSize: 11, background: '#EEEDFE', border: '0.5px solid #AFA9EC', borderRadius: 6, color: '#3C3489', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', fontWeight: 500 }}>
                Open Traceability
              </Link>
            </div>
          )}
